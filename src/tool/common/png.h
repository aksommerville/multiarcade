 ...
 *  - CRCs are not validated.
 *  - PLTE not validated -- Indexed images with no PLTE behave like gray.
 ...
 *  - We tolerate ancillary chunks before IHDR. Only IDAT must come after IHDR.
 *  - We do not require IEND.
